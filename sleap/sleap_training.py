...
# find all configs
backbone_folder_path_list = [r"C:\Users\SNeurobiology\code\3d-setup\sleap\models\241007_120850.single_instance.n=500\initial_config.json", r"C:\Users\SNeurobiology\code\3d-setup\sleap\models\241007_153439.single_instance.n=501\initial_config501.json" ]
...
for k in range(len(params)):
        ...
        for backbone_folder_path, model in zip(backbone_folder_path_list, models):
                ...
                original_json["outputs"]["run_name_prefix"] = f"{model}_batch{batch_size}_stride{stride}"
